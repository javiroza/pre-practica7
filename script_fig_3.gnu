...
# Títol del gràfic
set title "{/Symbol w}({/Symbol q}) (trajectòries a l'espai de configuració)"
...
# Plot 
plot "P7-1920-res.dat" index 0 using 2:3 with points t "Euler", \
"P7-1920-res.dat" index 1 using 2:3 with points t "Euler millorat"
#pause -1
