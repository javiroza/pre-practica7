...
# Títol del gràfic
set title "{/Symbol w}(t) grans oscil·lacions"
...
# Plot 
plot "P7-1920-res.dat" index 0 using 1:3 with points t "Euler", \
"P7-1920-res.dat" index 1 using 1:3 with points t "Euler millorat"
#pause -1
